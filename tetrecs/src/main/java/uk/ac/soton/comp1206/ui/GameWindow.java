...
public class GameWindow {
    ...
    public GameWindow(Stage stage, int width, int height) {
        ...
        //load game before going to start menu
    }
    ...
    public void loadGame() {
        loadScene(new GameLoadingScene(this));
    }
    ...
    /**
     * Display the scores
     * @param game The game object to base the scores on
     */
     ...
     * @param existingUsers users in the multiplayer game
     */
    public void loadMultiplayerScene(String currentPlayerName, ArrayList<String> existingUsers) {
        MultiplayerScene multiplayerScene = new MultiplayerScene(this,currentPlayerName,existingUsers);
